...
export class Initialdata1726116805442 implements MigrationInterface {
    name = 'Initialdata1726116805442'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "scheine" ("createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "isDeleted" boolean NOT NULL DEFAULT false, "id" SERIAL NOT NULL, "pdfUrl" text, "patientId" integer, "doctorId" integer, "templateId" integer, CONSTRAINT "PK_a6d08effa21fa1d7e3c3f8fd037" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_7e24f18ea8ad27dc71124afcac" ON "scheine" ("patientId", "doctorId", "templateId") `);
        await queryRunner.query(`CREATE TABLE "scheine_attribute" ("createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "isDeleted" boolean NOT NULL DEFAULT false, "id" SERIAL NOT NULL, "value" text NOT NULL, "scheineId" integer, CONSTRAINT "PK_51f682263b76cd885e93a005ca5" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "scheine_attribute" ADD CONSTRAINT "FK_4d4f94d986abc8ded90612af45a" FOREIGN KEY ("scheineId") REFERENCES "scheine"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "scheine_attribute" DROP CONSTRAINT "FK_4d4f94d986abc8ded90612af45a"`);
        ...
        await queryRunner.query(`DROP TABLE "scheine_attribute"`);
